...
const AstigmatismTestScreen = () => {
  ...
  // Function to handle the "Schedule at EyeFix" button press
  const handleSchedule = (email, clinicName) => {
    const subject = encodeURIComponent("Schedule an Appointment");
    const body = encodeURIComponent(
      `Hello ${clinicName},\n\nI would like to schedule an appointment. Here are my test details:\n\n` +
      `Left Eye Score: ${leftEyeScore}\nRight Eye Score: ${rightEyeScore}\n` +
      `Left Eye Test Result: ${leftEyeTestResult}\nRight Eye Test Result: ${rightEyeTestResult}\n` +
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView>
          ...
          {finalAstigmatismResult !== "You don't have astigmatism" && (
            <View style={styles.buttonRow}>
              <TouchableOpacity 
                onPress={() => handleSchedule("eyefixoptix@gmail.com", "EyeFix Optix")} 
                style={styles.scheduleButton}>
                <Text style={styles.scheduleButtonText}>Schedule at EyeFix</Text>
              </TouchableOpacity>

              <TouchableOpacity 
                onPress={() => handleSchedule("gamosamedcalamba@gmail.com", "Smartguys Community Healthcare")} 
                style={styles.scheduleButton}>
                <Text style={styles.scheduleButtonText}>Schedule at SmartGuys</Text>
              </TouchableOpacity>
            </View>
          )}
